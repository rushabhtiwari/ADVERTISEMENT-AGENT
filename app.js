...
const investorData = {
  eyebrow: '',
  title: 'Understand your Financial Health.<br><em>Know what matters next.</em>',
...
const doctorData = {
  ...
  copy: 'You mastered medicine. Let us handle the clarity around your finances, so nothing about money pulls you away from your work.',
  cta: 'Get Your Checkup 999',
  proof: '',
  theme: 'doctor'
};
...
function reportJourneySection(isDoctor=false) {
 const processSteps = [
  ['Form','After payment, you receive a short form. Fill it at your convenience or wait for our team to call and assist you.'],
  [isDoctor ? '24–48 Hour Prep' : '24–48 Hours','Once we receive your details, we analyse your numbers within 48 working hours and prepare your personalised review.'],
  ...
  ['Portfolio Benchmark',"Your existing investments are compared with relevant benchmarks to show what's working."],
...
function investorPage() {
 ...
 <section class="investor-next-actions"><div class="shell"><div class="next-actions-heading reveal"><h2>What to Do Next, in 3 Steps</h2></div><div class="next-actions-card reveal" aria-label="What to do next in three steps"><div class="next-actions-line" aria-hidden="true"></div><article class="next-action-step"><span class="next-action-number">1</span><div class="next-action-icon"><img src="/assets/investors/step-checkup-hourglass-3d.png" alt="" aria-hidden="true"></div><div><h3>Book Your Checkup</h3><p>Click the CTA, pay ₹999 securely, and reserve your review.</p></div></article><article class="next-action-step"><span class="next-action-number">2</span><div class="next-action-icon"><img src="/assets/investors/step-review-six-areas-3d.png" alt="" aria-hidden="true"></div><div><h3>Share Details, We Prepare Analysis</h3><p>You fill a short form (or get a callback). Our team reviews your numbers within 24-48 hours.</p></div></article><article class="next-action-step"><span class="next-action-number">3</span><div class="next-action-icon"><img src="/assets/investors/step-report-review-3d.png" alt="" aria-hidden="true"></div><div><h3>Get Your Score and Action Plan</h3><p>In your 1:1 review, you get your Financial Health Score, key gaps, and clear next steps.</p></div></article></div></div></section>
 ${reportJourneySection()}
 <section id="financial-health" class="investor-health-grid-section"><div class="shell"><div class="section-heading investor-health-heading reveal"><h2>Returns tell one part<br>Your financial health tells <em>the whole story.</em></h2></div><div class="investor-health-grid" aria-label="Six connected areas of financial health">${six.map(x=>`<article class="investor-health-card reveal"><div><h3>${x[0]}</h3></div><img src="assets/framework/${x[2]}" alt="" aria-hidden="true" loading="lazy" decoding="async"></article>`).join('')}</div></div></section>
 <section id="why" class="checkup-details"><div class="shell"><div class="checkup-form-card"><h2>What we ask in the checkup form</h2><p>It takes exactly 4 minutes. You'll need a rough estimate of your finances. (No exact account details needed.)</p><ul><li>Basic income and expense ranges</li><li>How much you save monthly</li><li>Lumpsum estimates of investments</li><li>Existing health &amp; life cover amounts</li><li>Target retirement age &amp; major goals</li><li>Any outstanding loans</li></ul></div><div class="cost-of-ignorance"><h3>The Cost of Ignorance</h3><p>"A 1% return gap on ₹25 Lakhs costs you ₹25,000 every single year.<br>A single health cover gap can wipe out savings. <strong>This checkup costs ₹999.</strong>"</p></div></div></section>
...
function doctorPage() {
 ...
 <section class="investor-next-actions doctor-next-actions"><div class="shell"><div class="next-actions-heading reveal"><h2>What to Do Next, in 3 Steps</h2></div><div class="next-actions-card reveal" aria-label="What to do next in three steps"><div class="next-actions-line" aria-hidden="true"></div><article class="next-action-step"><span class="next-action-number">1</span><div class="next-action-icon"><img src="/assets/investors/step-checkup-hourglass-3d.png" alt="" aria-hidden="true"></div><div><h3>Book Your Checkup</h3><p>Click the CTA, pay ₹999 securely, and reserve your review.</p></div></article><article class="next-action-step"><span class="next-action-number">2</span><div class="next-action-icon"><img src="/assets/investors/step-review-six-areas-3d.png" alt="" aria-hidden="true"></div><div><h3>Share Details, We Prepare Analysis</h3><p>You fill a short form (or get a callback). Our team reviews your numbers within 24-48 hours.</p></div></article><article class="next-action-step"><span class="next-action-number">3</span><div class="next-action-icon"><img src="/assets/investors/step-report-review-3d.png" alt="" aria-hidden="true"></div><div><h3>Get Your Score and Action Plan</h3><p>In your 1:1 review, you get your Financial Health Score, key gaps, and clear next steps.</p></div></article></div></div></section>
 ...
 <section class="framework shell"><div class="section-heading"><h2>6 areas. <em>1 vital view.</em></h2></div><div class="doctor-pillars">${frameworkItems.map(x=>`<button class="doctor-pillar"><img src="/assets/framework/${x[2]}" alt="" aria-hidden="true" loading="lazy" decoding="async"><b>${x[0]}</b></button>`).join('')}</div></section>
...
function faq(isDoctor=false) {
  const investorQs = [
    ...
    ['Do I have to move or change my investments?','No. The purpose of the checkup is to help you understand your current financial position and priorities.'],
    ['Who will do the review?','A trained financial planner from Finnovate (a SEBI Registered Investment Advisor).']
  ];
  const doctorQs = [
    ['What exactly do I receive for ₹999?','You receive a personalised Financial Fitness Score, a 9-page report, three priority actions and a 45-minute expert review.'],
    ['How much time does the assessment take?','The initial assessment takes around four minutes to complete.'],
    ['Is my information kept confidential?','Your financial information is handled privately for the purpose of preparing your Financial Fitness Checkup.'],
    ['Do I need to prepare a lot of documents before starting?','You begin with a short assessment. If any additional information is needed to complete the review, the team can guide you on what is required.'],
